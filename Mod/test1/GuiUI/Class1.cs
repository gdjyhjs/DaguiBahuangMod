...
namespace GuiUI
{
    public class Class1 : MelonMod
    {
        ...
        public override void OnApplicationStart()
        {
            ...
            new Log("欢迎使用八荒大鬼UI功能MOD 请关注我bilibili：八荒大鬼  我的QQ群：50948165");
                    ...
                    if (oldmd5 != newmd5)
                    {
                        if (isui)
                        {
                            ...
                            if (guidemo == "0" || string.IsNullOrWhiteSpace(guidemo))
                            {
                                if (verified)
                                {
                                    new Log("http 文件下载失败。" + Path.GetFileName(item.path));
                        ...
                        else
                        {
                            ...
                            new Log("开始修复本地资源：" + Path.GetFileName(item.path));
                            try
                            {
