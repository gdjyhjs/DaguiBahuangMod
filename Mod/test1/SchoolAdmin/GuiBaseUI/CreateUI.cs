...
namespace GuiBaseUI
{
    ...
    public static class CreateUI
    {
        ...
        public static GameObject NewDropdown(string[] options)
        {
            ...
            Image image = go1.GetComponent<Image>();
            image.sprite = SpriteTool.GetSprite("Common", "fenbianlv_2");
            ...
            img3.sprite = SpriteTool.GetSprite("Common", "sanjiao");
            ...
            img4.sprite = SpriteTool.GetSprite("Common", "daojukukuang_2");
            img4.type = Image.Type.Tiled;
            ...
            img6.sprite = SpriteTool.GetSprite("Common", "fenbianlv");
            ...
            img7.sprite = SpriteTool.GetSprite("Common", "sanjiao");
        ...
        public static GameObject NewInput(string placeholder = "", string defendValue = "")
        {
            GameObject go1 = NewImage(SpriteTool.GetSprite("Common", "mingzibgda"));
            go1.GetComponent<RectTransform>().sizeDelta = new Vector2(150, 30);
            InputField ipt = go1.AddComponent<InputField>();

            GameObject go2 = NewText(placeholder);
            go2.GetComponent<RectTransform>().sizeDelta = new Vector2(150, 30);
            go2.transform.SetParent(go1.transform, false);
            var t2 = go2.GetComponent<Text>();
            t2.alignment = TextAnchor.MiddleCenter;
            t2.color = new Color(0.5f, 0.5f, 0.5f);

            GameObject go3 = NewText("");
            go3.GetComponent<RectTransform>().sizeDelta = new Vector2(150, 30);
            go3.transform.SetParent(go1.transform, false);
            var t3= go3.GetComponent<Text>();
            t3.alignment = TextAnchor.MiddleCenter;

            ipt.targetGraphic = go1.GetComponent<Image>();
            ipt.placeholder = go2.GetComponent<Text>();
            ipt.textComponent = go3.GetComponent<Text>();
