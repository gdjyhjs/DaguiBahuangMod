...
namespace MOD_wkIh9W.Item
{
    ...
    {
        public UIDaoKindType(IntPtr ptr) : base(ptr) { }

        public Action<string, int> call; // 参数字符， 道种id
        public ConfTaoistSeedItem[] allItems
        {
            get
            {
                return g.conf.taoistSeed._allConfList.ToArray();
            }
        }
        ...
        void Awake()
        {
            ...
            textTitle.text = "选择道种";
            leftTitle.text = "可从下面选择道种";
            rightTitle.text = "已选择的道种";
        }
        ...
        public void InitData(UIDaguiToolItem toolItem, int index)
        {
            ...
            {
                var selectItem = item;
                var name = GameTool.LS(item.seedName);
        ...
        public void UpdateLeft()
        {
            ...
            var name = GameTool.LS(selectItem.seedName);
