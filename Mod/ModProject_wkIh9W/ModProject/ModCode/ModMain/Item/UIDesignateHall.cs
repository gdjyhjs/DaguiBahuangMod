...
namespace MOD_wkIh9W.Item
{
    ...
    {
        public UIDesignateHall(IntPtr ptr) : base(ptr) { }

        public Action<string, string> call; // 参数字符， 分堂id

        public static DataStruct<string, string>[] allAttr = new DataStruct<string, string>[]{
            new DataStruct<string, string>("4", "修筑堂"),
            new DataStruct<string, string>("1", "招贤堂"),
            new DataStruct<string, string>("5", "贮宝堂"),
            new DataStruct<string, string>("3", "外务堂"),
            new DataStruct<string, string>("2", "巡查堂"),
        };
